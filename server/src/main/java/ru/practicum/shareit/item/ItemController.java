...
public class ItemController {
    ...
    @PostMapping
    public ItemDto postItem(@RequestHeader(userIdHeader) int userId, @RequestBody ItemDto itemDto) {
    ...
    @DeleteMapping("/{id}")
    public ItemDto deleteItem(@RequestHeader(userIdHeader) int userId, @PathVariable int id) {
